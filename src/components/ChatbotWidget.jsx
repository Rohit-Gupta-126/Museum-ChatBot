...
export default function ChatbotWidget() {
    ...
    return (
        ...
        >
            ...
            {isOpen && (
                <motion.div
                    className="w-96 h-[520px] glass-panel shadow-xl flex flex-col"
                ...
                >
                    ...
                    <div className="p-4 border-t border-terracotta-500/40 bg-opacity-50">
                        <div className="flex items-center space-x-2">
                            <input
                                type="text"
                                placeholder="Type your message..."
                                className="flex-1 p-3 rounded-lg bg-sienna-600/50 text-white focus:outline-none"
                            />
